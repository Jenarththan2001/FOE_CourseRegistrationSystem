...
namespace FOE_CourseRegistrationSystem.Migrations
{
    ...
    [Migration("20250327164119_AddNotificationTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FOE_CourseRegistrationSystem.Models.Notification", b =>
                {
                    ...
                    b.Property<int?>("RelatedPendingRegistrationID")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ThirdPartyMessage")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int?>("ThirdPartyStaffID")
                        .HasColumnType("int");

                    b.Property<int?>("ThirdPartyStudentID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RelatedPendingRegistrationID");
                    ...
                    b.HasIndex("ThirdPartyStaffID");

                    b.HasIndex("ThirdPartyStudentID");
            ...
            modelBuilder.Entity("FOE_CourseRegistrationSystem.Models.Notification", b =>
                {
                    b.HasOne("FOE_CourseRegistrationSystem.Models.PendingRegistration", "RelatedPendingRegistration")
                        .WithMany()
                        .HasForeignKey("RelatedPendingRegistrationID");

                    b.HasOne("RegistrationSession", "RelatedSession")
                        .WithMany()
                        .HasForeignKey("RelatedSessionID");

                    b.HasOne("FOE_CourseRegistrationSystem.Models.Staff", "RelatedStaff")
                        .WithMany()
                        .HasForeignKey("RelatedStaffID");

                    b.HasOne("FOE_CourseRegistrationSystem.Models.Student", "RelatedStudent")
                        .WithMany()
                        .HasForeignKey("RelatedStudentID");

                    b.HasOne("FOE_CourseRegistrationSystem.Models.Staff", "SenderStaff")
                        .WithMany()
                        .HasForeignKey("SenderStaffID");

                    b.HasOne("FOE_CourseRegistrationSystem.Models.Student", "SenderStudent")
                        .WithMany()
                        .HasForeignKey("SenderStudentID");

                    b.HasOne("FOE_CourseRegistrationSystem.Models.Staff", "ThirdPartyStaff")
                        .WithMany()
                        .HasForeignKey("ThirdPartyStaffID");

                    b.HasOne("FOE_CourseRegistrationSystem.Models.Student", "ThirdPartyStudent")
                        .WithMany()
                        .HasForeignKey("ThirdPartyStudentID");

                    b.Navigation("RelatedPendingRegistration");
                    ...
                    b.Navigation("ThirdPartyStaff");

                    b.Navigation("ThirdPartyStudent");
                });
