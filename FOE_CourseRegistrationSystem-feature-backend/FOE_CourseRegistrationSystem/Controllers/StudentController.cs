...
namespace FOE_CourseRegistrationSystem.Controllers
{
    ...
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> GetAvailableCourses()
        {
            ...
            var alreadySubmittedCourses = await _context.PendingRegistrations
               .Where(pr => pr.StudentID == student.StudentID && openSessionIDs.Contains(pr.SessionID))
               .Select(pr => pr.CourseCode)
               .ToListAsync();


            Console.WriteLine($"✅ Passed Courses: {string.Join(", ", passedCourses)}");
            Console.WriteLine($"✅ Already Approved Courses: {string.Join(", ", alreadySubmittedCourses)}");
            ...
            var availableCourses = openSessions
                ...
                .SelectMany(rs => rs.RegistrationSessionCourses
                    .Where(rsc =>
                        !alreadySubmittedCourses.Contains(rsc.Course.CourseCode) &&  // Only approved should be blocked
